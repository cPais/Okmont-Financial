...
<html lang="en">
<head>
  <title>Roth IRA Portfolios</title>
  <meta charset="utf-8">
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-12 text-left"> 
      <h1>Roth IRA Portfolios</h1>
      <p><span style="font-weight: bold;">Roth IRA portfolio description</span> covers private passenger vehicles. It provides protection against economic loss to an insured from bodily injury or property damage to others (liability) arising from the operation, maintenance, or use of a covered automobile. Coverage may also be purchased for damage to vehicles owned by you </p>
